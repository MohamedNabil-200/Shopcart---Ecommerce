...
const ShopByBrands = async () => {
  ...
  return (
    <div className="mb-10 lg:mb-20 bg-shop-light-bg p-5 lg:p-7 rounded-md">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-16 p-2 shadow-sm shadow-shop-light-green/20 py-5">
        {extraData?.map((item, index) => (
          <div
            key={index}
            className="flex items-center gap-3 group text-light-green hover:text-shop-light-green"
          >
            ...
            <div className="text-sm">
              ...
              <p className="text-light-color">{item?.description}</p>
            </div>
          </div>
        ))}
      </div>
